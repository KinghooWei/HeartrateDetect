...
public class DetectActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraView.setCameraIndex(CameraBridgeViewBase.CAMERA_ID_BACK);//默认后置
        initClassifier();
...
//        int color=Color.parseColor("#555555");
    ...
    private class UIHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            process.setVisibility(View.VISIBLE);//控件显示
        }
    }
...
//                    Thread.sleep(params[0]);
        ...
        protected void onPostExecute(String result) {
            Toast.makeText(DetectActivity.this, "11", Toast.LENGTH_SHORT).show();
